...
class FamtarController(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("--- Kontroler FAMTAR v1.2 (Final) uruchomiony ---")
    ...
    # WAŻNA ZMIANA: Usunięto MAIN_DISPATCHER, aby zapewnić odkrywanie połączeń
    ...
    def _packet_in_handler(self, ev):
        ...
        if dst in self.mac_to_port:
            ...
            try:
                ...
                actions = [datapath.ofproto_parser.OFPActionOutput(out_port_first_hop)]

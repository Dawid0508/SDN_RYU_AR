# last_dance.py - WERSJA FINALNA I POPRAWIONA
...
class ProjectController(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Inicjalizujemy jako zwykły słownik, koszty będą dodawane dynamicznie
        self.dynamic_costs = {}
        self.link_stats = {}
                    ...
                    if key in self.link_stats:
                        ...
                        if time_diff > 0:
                            ...
                            if capacity > 0:
                                ...
                                th_max, th_min = 80.0, 70.0
                                # Logika histerezy - reaguje tylko na przekroczenie progów
    ...
    def _link_add_handler(self, ev):
        ...
        # --- POPRAWKA: Ustawiamy koszt początkowy na podstawie przepustowości ---
        link_tuple = (s1, s2)
    ...
    def _get_path(self, src, dst, first_port, final_port):
        ...
        while Q:
            ...
            for p in self.adjacency[u].keys():
                # Używamy .get() z bezpieczną wartością domyślną 1
